<%@ Page Title="Edit Business or Contact" Language="C#" MasterPageFile="~/Views/Shared/Admin.Master" Inherits="System.Web.Mvc.ViewPage<BidForKids.Models.Contact>" %>

<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
	Edit Business or Contact
</asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">

    <h2>Edit Business or Contact</h2>
    ...
    <% using (Html.BeginForm()) {%>
        ...
        <fieldset>
            ...
            <p>
                <label for="BusinessName">Busines sName:</label>
            ...
            <p>
                <label for="Phone1Desc">Phone 1 Desc:</label>
            ...
            <p>
                <label for="Phone2Desc">Phone 2 Desc:</label>
            ...
            <p>
                <label for="Phone3Desc">Phone 3 Desc:</label>
